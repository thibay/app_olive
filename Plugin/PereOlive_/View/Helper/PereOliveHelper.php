 ...
 * PereOlive Helper
 *
 * An pereolive hook helper for demonstrating hook system.
 *
 * @category Helper
 * @package  Croogo
 * @version  1.0
 ...
 */
class PereOliveHelper extends AppHelper {
 ...
 */
	public function afterSetNode() {
		...
		$this->Nodes->field('title', $this->Nodes->field('title') . ' [Modified by PereOliveHelper]');
	}
