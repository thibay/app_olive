...
//                echo $this->Form->input('Recipe.image', array('type' => 'file'));
//                echo $this->Form->input('Recipe.image_dir', array('type' => 'hidden'));                
//                echo "<div class='input text' style='margin-top:-20px'>". $this->Html->image("/files/recipes/image/{$this->Form->value('Recipe.image_dir')}/thumb_{$this->Form->value('Recipe.image')}").'</div>';                                
				...
				echo $this->Form->input('website', array(
					...
					'label' => 'Page Twitter de l\'artiste',
                                ...
                                echo $this->Media->iframe('PereOlive.Recipe', $this->Form->value('Recipe.id'));
				echo $this->Croogo->adminTabs();
			?>
			</div>
		</div>
