 ...
 */
	public function onActivation(&$controller) {
		...
		$controller->Croogo->addAco('PereOlive/Recipes/home_recipes', array('contenteditor', 'public')); // PereOliveController::index()
                $controller->Croogo->addAco('PereOlive/News/index', array('contenteditor', 'public')); // PereOliveController::index()
		$controller->Croogo->addAco('PereOlive/News/view', array('contenteditor', 'public')); // PereOliveController::index()
                $controller->Croogo->addAco('PereOlive/News/home_promoted', array('contenteditor', 'public')); // PereOliveController::index()
