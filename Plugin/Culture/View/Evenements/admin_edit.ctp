...
if ($this->action == 'admin_edit') {
	$this->Html->addCrumb($this->data['Evenement']['name'], $this->here);
	$this->viewVars['title_for_layout'] = 'Evenements: ' . $this->data['Evenement']['name'];
} else {
	$this->Html->addCrumb(__d('croogo', 'Add'), $this->here);
}

echo $this->Form->create('Evenement', array('type' => 'file'));
...
<div class="events row-fluid">
	<div class="span8">
		...
		<?php
			echo $this->Croogo->adminTab(__d('croogo', 'Evenement'), '#event');
...
//                echo $this->Form->input('Evenement.image', array('type' => 'file'));
//                echo $this->Form->input('Evenement.image_dir', array('type' => 'hidden'));                
//                echo "<div class='input text' style='margin-top:-20px'>". $this->Html->image("/files/evenements/image/{$this->Form->value('Evenement.image_dir')}/thumb_{$this->Form->value('Evenement.image')}").'</div>';                                
				...
				echo $this->Form->input('to_date', array(
					...
					'label' => 'Prix pour les membres Bibliothèque', 'default' => '0'
                                ...
                                echo $this->Form->input('price_member_culture', array(
					'label' => 'Prix pour les membres Fleurus Culture', 'default' => '0'
				));
				...
				echo $this->Form->input('website', array(
					...
					'label' => 'Page Twitter de l\'artiste',
                                ...
                                echo $this->Media->iframe('Culture.Evenement', $this->Form->value('Evenement.id'));
				echo $this->Croogo->adminTabs();
			?>
			</div>
		</div>
