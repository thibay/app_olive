 ...
 * Culture Helper
 *
 * An culture hook helper for demonstrating hook system.
 *
 * @category Helper
 * @package  Croogo
 * @version  1.0
 ...
 */
class CultureHelper extends AppHelper {
 ...
 */
	public function afterSetNode() {
		...
		$this->Nodes->field('title', $this->Nodes->field('title') . ' [Modified by CultureHelper]');
	}
