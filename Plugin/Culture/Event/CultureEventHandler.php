 ...
 */
class CultureEventHandler extends Object implements CakeEventListener {
 ...
 */
	public function onLayoutAfterFilter($event) {
		if (strpos($event->data['content'], 'This is') !== false) {
			$event->data['content'] .= '<blockquote>This is added by CultureEventHandler::onLayoutAfterFilter()</blockquote>';
		}
	}
